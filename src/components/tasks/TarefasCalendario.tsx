...
import { ChevronLeft, ChevronRight, Search, Settings, Sun } from "lucide-react";
import { cn } from '@/lib/utils';
import { format, addDays, subDays, startOfWeek, endOfWeek, eachDayOfInterval, getDay, isSameMonth, isToday, isSameDay, startOfMonth, endOfMonth, subMonths, addMonths, subYears, addYears } from 'date-fns';
...
const Sidebar = ({ currentDate, setCurrentDate }) => {
    ...
    return (
        <aside className="w-80 flex-shrink-0 bg-gray-800/50 border-r border-gray-700 p-4 flex-col gap-6 hidden lg:flex">
