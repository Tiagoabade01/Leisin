...
import CatalogoIntegracoes from '@/components/master/integracoes/CatalogoIntegracoes';
    ...
    <div className="space-y-6">
      <header className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          <Button><PlusCircle className="h-4 w-4 mr-2" /> Nova Integração</Button>
          <Button variant="outline" className="bg-gray-800 border-gray-700"><KeyRound className="h-4 w-4 mr-2" /> Gerar Token</Button>
          <Button variant="outline" className="bg-gray-800 border-gray-700"><FileText className="h-4 w-4 mr-2" /> Ver Logs</Button>
          <Button variant="outline" className="bg-gray-800 border-gray-700"><BrainCircuit className="h-4 w-4 mr-2" /> Diagnóstico IA</Button>
        </div>
      </header>
      ...
      <Tabs defaultValue="visao_geral" className="w-full">
        ...
        <TabsContent value="catalogo" className="mt-6"><CatalogoIntegracoes /></TabsContent>
